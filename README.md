...
## Objectif du projet
Le Théremin est un appareil permettant de générer un signal audible, dont l'amplitude et la fréquence sont contrôlées par l'utilisateur au moyen de deux capteurs de distance.  
L'appareil peut être utilisé sur secteur ou de manière nomade grâce à une batterie interne.  

Grâce la gestuelle des mains par rapport aux capteurs, la fréquence et l'amplitude du signal audio peuvent être modifiées.  

### Journal de travail
Chemin : PRJ_2204_Theremin_JJE\doc\V3
